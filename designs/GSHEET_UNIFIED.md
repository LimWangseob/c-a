...
- [x] 서식: 제목 병합·**제목줄 전체 동일 헤더색**(진한 청회색 B7C9E8·굵게)·**사업자별 밴드색 8색 순환**(행 전체 A~G 동일·인접 사업자 다름·중간 채도로 **웜↔쿨 교대**=대비, 너무 진하지 않게, 사용자 지정)·틀고정(2행·A~C 3열)·열너비·B열 HYPERLINK. (2026-09-14: 헤더 열별 이색·마케팅 안내색 FFF2CC 폐지 → 제목줄 단색 통일; 밴드 2색→8색, 흐릿→중간채도 웜/쿨 교대로 대비 강화.)
